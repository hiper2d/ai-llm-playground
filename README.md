...
# <a id="web_scraper"></a>Web Scraper based on Vision API

Credits go to [gpt4v-browsing](https://github.com/unconv/gpt4v-browsing) repo as a source of ~~copy-paste~~ inspiration. The idea is nice and simple: let's make a screenshot of a web page and ask OpenAI Vision API to recognize stuff on it, and give us some analytics. And maybe even navigate and click buttons by our command. I always hated scraping autogenerated HTML pages, this is a super nice alternative. Let's see how far I can go with this.  
